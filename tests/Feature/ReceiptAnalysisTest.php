...
class ReceiptAnalysisTest extends TestCase
{
    ...
    public function test_receipt_analysis_keeps_long_single_line_description(): void
    {
        config([
            'services.financial_management.url' => 'https://demo.webpulse.ca/api/financial-management',
            'services.financial_management.token' => 'test-token',
        ...
        Storage::fake('public');
        $description = 'Restaurant purchase including appetizers, entrees, drinks, dessert, service charge, and invoice reference generated by the financial management analysis service';
        Http::fake([
            'https://demo.webpulse.ca/api/financial-management' => Http::response([
                'success' => true,
                'analysis' => [
