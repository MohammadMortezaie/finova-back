...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        button, a.button { width:100%; display:block; border:0; background:var(--accent); color:#121212; text-align:center; text-decoration:none; font-weight:900; padding:14px; border-radius:14px; }
...
<body>
    <main>
        ...
        <p>Enter your account email. We will send a 6-digit reset code.</p>
